...
class Users
{
    ...
    public function setCountry(string $country): Users
    {
    ...
    public function setZipCode(int $zip_code): Users
    {
    ...
    public function setPhone(int $phone): Users
    {
        $this->phone = $phone;
    ...
    public function setCreatedAt(\DateTime $created_at): Users
    {
    ...
    public function setUpdatedAt(\DateTime $updated_at): Users
    {
    ...
    public function setDeletedAt(\DateTime $deleted_at): Users
    {
